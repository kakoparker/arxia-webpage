...
// Default node runtime: lets Next pre-generate the OG image at build time
// (edge runtime would disable static generation). ImageResponse works on
// both runtimes; nodejs avoids the Vercel-specific edge cold-start path.
